...
/**
 * 自定义的RadioGroup ，继承于RelativeLayout，实现对RadioButton相对的布局
 * 
 * @ClassName: MyGroup
 * @Description: TODO
 * @date 2014-4-3 
...
public class Mygroup extends RelativeLayout {
	...
	public LayoutParams generateLayoutParams(AttributeSet attrs) {
		return new Mygroup.LayoutParams(getContext(), attrs);
	}
	...
	protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
		return p instanceof Mygroup.LayoutParams;
	}
	...
	public interface OnCheckedChangeListener {
		 ...
		 */
		public void onCheckedChanged(Mygroup group, int checkedId);
	}
	...
	private class PassThroughHierarchyChangeListener implements
		...
		public void onChildViewAdded(View parent, View child) {
			if (parent == Mygroup.this && child instanceof RadioButton) {
				int id = child.getId();
